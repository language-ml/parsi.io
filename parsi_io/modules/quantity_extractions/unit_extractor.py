...
with open(str(path)+'/resources/dataset/prefixes.json', 'r', encoding='utf-8') as file:
    prefixes_dict = json.load(file)
with open(str(path)+'/resources/dataset/units.json', 'r', encoding='utf-8') as file:
    units_dict = json.load(file)
with open(str(path)+'/resources/dataset/quantities.json', 'r', encoding='utf-8') as file:
