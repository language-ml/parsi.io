...
class TestVerbInfoExtractor(BaseTest):    
    def run_test(self):
        errors = []
        test_cases = self.get_testcases('/parsi_io/test/testcases/VerbInfoExtraction.json')
        obj = VerbInfoExtraction()
...
if __name__ == '__main__':
    TestVerbInfoExtractor().run_test()
